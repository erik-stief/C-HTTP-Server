...
**Informational**: I wanted to include these codes because while they are not used in HTTP/1.0, they can be used in experimental applications.
**Successful**: client request is successfully received, understood, and accepted.
